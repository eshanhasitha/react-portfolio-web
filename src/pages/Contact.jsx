          ...
          <div className='flex flex-col lg:flex-row gap-8 sm:gap-10 lg:gap-16'>
            ...
            <div className='flex flex-col gap-6 sm:gap-8 flex-1'>
              ...
              <div className='flex flex-col gap-4 sm:gap-6 mt-2 sm:mt-4'>
                <div className='flex gap-3 sm:gap-5 items-center p-3 sm:p-4 bg-[#334155]/40 rounded-xl border border-white/10 hover:border-white/20 hover:bg-[#475569]/30 transition-all duration-500 ease-out group hover:scale-105'>
              ...
              <form action="https://formsubmit.co/eshanhasitha13@gmail.com" method='POST' className='space-y-4 sm:space-y-5'>
                <div>
                  ...
                  <input 
                    ...
                    required
                    className='w-full p-3 sm:p-4 rounded-lg border border-white/10 outline-none bg-[#334155]/40 text-[#F1F5F9] text-sm sm:text-base placeholder-[#94A3B8] focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/30 transition-all duration-500 ease-out hover:border-white/20'
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea 
                    ...
                    required
                    className='w-full p-3 sm:p-4 rounded-lg border border-white/10 outline-none bg-[#334155]/40 text-[#F1F5F9] text-sm sm:text-base placeholder-[#94A3B8] focus:border-[#3B82F6] focus:ring-2 focus:ring-[#3B82F6]/30 transition-all duration-500 ease-out resize-none hover:border-white/20'
                  />
                </div>
