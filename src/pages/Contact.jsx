  ...
  return (
    <>
      <div className='flex flex-col'>
        <div className='flex flex-col items-center justify-center mx-4 my-25 md:mx-16 lg:mx-32 xl:mx-44 p-8 md:p-12 bg-[#1E293B] rounded-2xl shadow-2xl border border-[#475569]/30' id='contact'>
