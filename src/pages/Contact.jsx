    ...
    <>
      <div className='mx-5 my-20 md:mx-28 lg:mx-44 p-8 md:p-12 bg-[#161513] rounded-2xl relative' style={{
        ...
        <div className='text-center'>
          <h1 className='text-5xl lg:text-7xl font-bold text-white mb-4'>Contact Me !.</h1>
        </div>

        {/* Main Content */}
        <div className='flex flex-col lg:flex-row gap-12 lg:gap-24 mt-16 md:mt-24'>
          
          {/* Left Section */}
          <div className='flex flex-col gap-5 flex-1'>
            <h1 className='text-3xl md:text-5xl font-bold bg-gradient-to-r from-[#DA7C25] to-[#B923E1] bg-clip-text text-transparent'>
              Lets talk
            </h1>
            ...
            <div className='flex flex-col gap-4 mt-4'>
              ...
              <div className='flex gap-5 items-center'>
                <img 
                  ...
                  className='w-8 h-8 md:w-10 md:h-10'
                />
                <p className='text-gray-300 text-base md:text-lg'>+94 77 4506 950</p>
              </div>
              ...
              <div className='flex gap-5 items-center'>
                ...
                />
                <p className='text-gray-300 text-base md:text-lg'>Sri Lanka</p>
              </div>
            </div>
          </div>
          ...
          <div className='flex-1'>
            <form action="https://formsubmit.co/eshanhasitha13@gmail.com" method='POST' className='flex flex-col'>
              <input 
                type="text" 
                name='name' 
                placeholder='Name' 
                required
                className='m-2 w-full p-3 rounded-lg border-none outline-none bg-[#32323B] text-white text-lg md:text-xl'
              />
              <input 
                type="email" 
                name='email' 
              ...
              <textarea 
                ...
                placeholder='Message' 
                required
                className='m-2 w-full p-3 rounded-lg border-none outline-none bg-white text-black text-lg md:text-xl'
              />
              ...
              <div className='m-2 flex flex-row justify-between gap-4'>
                <button 
                  type='reset' 
                  className='border-none text-white px-6 md:px-10 py-3 md:py-4 rounded-full bg-gradient-to-r from-[#DA7C25] to-[#B923E1] text-xl md:text-2xl font-bold cursor-pointer transition-all duration-500 hover:scale-105 hover:text-black active:text-white'
                >
                  Reset
                </button>
                <button 
